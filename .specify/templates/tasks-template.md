...
## Constitution-driven Task Types (include when applicable)

- Multiplayer sync: deterministic simulation tests, packet contract tests, and desync detectors
- Performance: tick-time benchmarks under the “Medium” profile; memory footprint measurement
- Compatibility: Java-only and Java+Bedrock-bridge smoke tests; compatibility matrix updates
- Save/migration: schema bump, migration steps, backup/verification tooling
