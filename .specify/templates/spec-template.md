...
- Cross-Edition Compatibility (Java-only and Java+Bedrock-bridge behavior documented)
- Deterministic Multiplayer Sync (no client authority; deterministic test noted)
- Performance Budgets (expected tick-time/memory and measurement plan)
- Modularity & Public APIs (impacted modules/APIs and change notes)
- Save/Migration (schema version bump and migration, if applicable)
